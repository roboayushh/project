...
export default function MyTasks() {
  const [tasks, setTasks] = useState([
    { id: 1, name: 'Review design mockups', description: 'Check the new UI designs', dueDate: '2025-01-15', priority: 'High', status: 'On track', section: 'Work' },
    { id: 2, name: 'Update documentation', description: 'Update API documentation', dueDate: '2025-01-20', priority: 'Medium', status: 'At risk', section: 'Work' },
    { id: 3, name: 'Buy groceries', description: 'Weekly grocery shopping', dueDate: '2025-01-12', priority: 'Low', status: 'On track', section: 'Personal' },
  ]);

  const [sections, setSections] = useState(['Work', 'Personal']);
